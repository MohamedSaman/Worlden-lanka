<div class="container-fluid py-4">
    <div class="card border-0 shadow">
        ...
        <div class="card-header bg-transparent py-3 border-bottom" style="border-color: #233D7F;">
            <p class="mb-0 text-muted">Use the left panel to search by customer or invoice. Select one, then choose a product to process re-entry and damage on the right.</p>
        </div>
                                    ...
                                    <form wire:submit.prevent="updateStock">
                                        ...
                                        <div class="d-grid">
                                            <button type="submit" class="btn btn-primary btn-md mx-auto" style="background-color: #d34d51ff; border-color: #d34d51ff; color: white;" onmouseover="this.style.backgroundColor='#9d1c20'; this.style.borderColor='#9d1c20';" onmouseout="this.style.backgroundColor='#d34d51ff'; this.style.borderColor='#d34d51ff';">
                                                <i class="bi bi-check-circle me-2"></i>Process Re-Entry
                                            </button>
                                        </div>
...
<style>
    ...
    .product-card { border-radius: 12px; cursor: pointer; transition: all 0.3s ease; }
    .product-card:hover, .product-card.selected { box-shadow: 0 0 0 2px #d34d51ff; transform: translateY(-2px); }
