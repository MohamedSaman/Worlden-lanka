<div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" wire:click="">Add Brand</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    {{-- Edit Category Model --}}
    <div wire:ignore.self wire:key="" class="modal fade" id="editCategoryModal"
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary"
                        wire:click="">Update Category</button>
                </div>
            </div>
        </div>
    </div>
