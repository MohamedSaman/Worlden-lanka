                ...
                <div class="card border-0 shadow-sm rounded-4 h-100 transition-all hover:scale-105">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center">
                            <div class="icon-shape icon-lg bg-opacity-10 me-3 text-center">
                                <i class="bi bi-wallet text-info"></i>
                            </div>
                            <div>
                                <p class="text-xs text-gray-600 mb-0 text-uppercase fw-semibold">Total Payments</p>
                                <div class="d-flex align-items-baseline mt-1">
                                    <h3 class="mb-0 fw-bold text-gray-800">Rs.{{ number_format($totalPayments, 2) }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <div class="d-flex align-items-baseline mt-1">
                                    <h3 class="mb-0 fw-bold text-gray-800">Rs.{{ number_format($pendingPayments, 2) }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <table class="table table-bordered table-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>Rs.{{ number_format(($item->price * $item->quantity) - $item->discount, 2) }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
