                ...
                <table class="table table-hover">
                    ...
                    <tbody wire:key="watches-{{ now() }}">
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{ $product->certification }}</td>
                            <td class="text-center">{{ $product->machine_type }}</td>
                            ...
                            <td class="text-center">
                                <div class="action-btns" style="justify-content: center;">
                                    <button class="btn action-btn edit" title="Edit"
                                        wire:click="editWatch({{ $product->id }})"
                                        wire:loading.attr="disabled">
                                        <i class="bi bi-pencil" wire:loading.class="d-none"
                                            wire:target="editWatch({{ $product->id }})"></i>
                                        <span wire:loading wire:target="editWatch({{ $product->id }})">
                                    ...
                                    <button class="action-btn qr" title="View"
                                        wire:click="viewWatch({{ $product->id }})">
                                        <i class="bi bi-eye"></i>
                                    </button>
                                </div>
                            </td>
